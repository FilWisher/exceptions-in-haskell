...
\section{Continuations}
  ...
  returns another suspended computation:
  
  \footnote{ \mono{(>>=)} is pronounced 'bind'.}
  ...
  We define another operator, $return$, that takse a value and returns a 
  ...
  computations that can be composed using \mono{>>=}. 
